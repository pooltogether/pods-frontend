...
export const PINK_BUTTON_CLASSES = 'font-bold hover:bg-purple-1100 hover:text-white trans trans-fast hover:border-white text-denverPink-400 border-4 border-denverPink-400 rounded-full pb-2 pt-2 px-6 text-lg sm:text-xl lg:text-2xl'
